    ...
    <>
      <div className="group/notifications relative">
        <button
          ...
          className="relative grid h-10 w-10 place-items-center rounded-full border border-slate-200 bg-white/80 text-slate-700 shadow-sm transition hover:border-primary/40 hover:text-primary dark:border-white/10 dark:bg-white/10 dark:text-slate-200 dark:hover:bg-white/15 dark:hover:text-white"
        ...
        <div className="invisible pointer-events-none fixed inset-x-2 top-[4.75rem] z-[90] w-auto origin-top translate-y-3 scale-95 opacity-0 transition duration-200 ease-out group-hover/notifications:visible group-hover/notifications:pointer-events-auto group-hover/notifications:translate-y-0 group-hover/notifications:scale-100 group-hover/notifications:opacity-100 group-focus-within/notifications:visible group-focus-within/notifications:pointer-events-auto group-focus-within/notifications:translate-y-0 group-focus-within/notifications:scale-100 group-focus-within/notifications:opacity-100 sm:absolute sm:left-auto sm:right-0 sm:top-full sm:w-[min(390px,calc(100vw-32px))] sm:pt-3">
          <div className="overflow-hidden rounded-lg border border-slate-200 bg-white shadow-[0_22px_60px_rgba(15,23,42,0.18)] dark:border-white/10 dark:bg-[#07152d]">
            <div className="flex items-center justify-between gap-3 border-b border-slate-200 p-3 dark:border-white/10">
              ...
              <Button type="button" variant="ghost" className="h-8 shrink-0 rounded-md px-2" onClick={markAllRead} disabled={!inboxNotifications.length}>
            ...
            <div className="max-h-[min(24rem,calc(100dvh-13rem))] overflow-y-auto p-2">
                  ...
                  >
                    <div className="flex min-w-0 items-start justify-between gap-3">
                      <button type="button" className="min-w-0 flex-1 text-left" onClick={() => openDetail(notification)}>
                        ...
                        <span className="mt-1 block line-clamp-2 text-xs leading-5 text-slate-500 dark:text-slate-400">{notification.message}</span>
